...
// Ported from a TSX/shadcn snippet to plain JSX for this CRA project. Behavior is
// unchanged; only TypeScript annotations were removed and comments translated.
...
class AnimationController {
  ...
  // Seed the RNG so the field is deterministic, build stars, then restore.
  ...
  // Rotate v1 around the midpoint of (v1, v2)
  ...
  // Project a 3D point and draw it
...
export function SpiralAnimation() {
  ...
  // Create and manage the animation
  useEffect(() => {
    ...
    // Handle device pixel ratio to keep the canvas crisp.
